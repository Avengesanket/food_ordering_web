  ...
  return (
    <>
      <section className="mx-auto w-4/5">
        <h1 className="text-center text-3xl font-bold text-colorSNav drop-shadow leading-relaxed">
          Register
        </h1>
        <form className="flex flex-col gap-3 my-3" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-1/3 mx-auto hover:text-white hover:bg-colorSNav bg-gray-200 text-colorSNav border-colorSNav"
          >
            REGISTER
          </button>
          <button className="flex items-center justify-center w-1/3 mx-auto hover:text-white hover:bg-colorSNav bg-gray-200 text-colorSNav border-colorSNav">
            <Image src="/google.png" alt="Google Logo" width={35} height={35} />
            LOGIN WITH GOOGLE
          </button>
        </form>
      </section>
