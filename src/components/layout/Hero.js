        ...
        <div className="my-5 flex items-center justify-between mx-auto gap-3 w-4/5">
            <div className="leading-8 drop-shadow-sm py-10">
                <h1 className="text-3xl font-bold text-white leading-relaxed">
                    <span className="text-amber-300 text-5xl">Hungry?</span><br />
                     We&apos;ve Got You Covered!</h1>
                <p className="text-2xl font-semibold text-white leading-relaxed">
                <span className="text-orange-400 text-3xl drop-shadow">Food</span> that Speaks to Your <span className="text-orange-400 drop-shadow">Heart</span>, and Your Palate.</p>
